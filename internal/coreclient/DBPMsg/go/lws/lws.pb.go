...
func (Transaction_CDestination_PREFIX) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{4, 1, 0}
}
...
func (*ForkID) Descriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{0}
}
...
func (*GetBlocksArg) Descriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{1}
}
...
func (*GetTxArg) Descriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{2}
}
...
func (*SendTxArg) Descriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{3}
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{4}
}
...
func (*Transaction_CTxIn) Descriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{4, 0}
}
...
func (*Transaction_CDestination) Descriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{4, 1}
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{5}
}
...
func (*SendTxRet) Descriptor() ([]byte, []int) {
	return fileDescriptor_lws_125312bf72b36b2b, []int{6}
}
...
func init() { proto.RegisterFile("lws.proto", fileDescriptor_lws_125312bf72b36b2b) }

var fileDescriptor_lws_125312bf72b36b2b = []byte{
	// 573 bytes of a gzipped FileDescriptorProto
	,
}
